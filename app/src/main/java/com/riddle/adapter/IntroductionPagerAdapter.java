...
public class IntroductionPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        IntroductionModel modelObject = IntroductionModel.values()[position];
    ...
    public int getCount() {
        return IntroductionModel.values().length;
    }
    ...
    public CharSequence getPageTitle(int position) {
        IntroductionModel customPagerEnum = IntroductionModel.values()[position];
